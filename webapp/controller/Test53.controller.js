...
"sap/m/Input"
	...
	"use strict";
	return Controller.extend("ui5.walkthrough.controller.Test53", {
		onInit: function() {
			// 기본 설정 셋팅
			this.initDefaultInfo();
			// 라우터 초기화
			var oRouter = this.getOwnerComponent().getRouter();
			oRouter.getRoute("test53").attachPatternMatched(this._onRouteMatched, this);
		...
		initDefaultInfo: function() {
			...
			this.search_model = this.getOwnerComponent().getModel("Northwind_4389_Test53_search_model");
			this.odata_model_name = "Northwind_4389_Test53_model";
			this.odata_model = this.getOwnerComponent().getModel(this.odata_model_name);
			this.entity_set_name = "Products";
